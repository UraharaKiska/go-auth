...
func (m *UserInfo) validate(all bool) error {
	...
	if l := utf8.RuneCountInString(m.GetPasswordConfirm()); l < 6 || l > 50 {
		err := UserInfoValidationError{
...
// Validate checks the field values on UserInfoSecure with the rules defined in
// the proto definition for this message. If any rules are violated, the first
// error encountered is returned, or nil if there are no violations.
func (m *UserInfoSecure) Validate() error {
	return m.validate(false)
}

// ValidateAll checks the field values on UserInfoSecure with the rules defined
// in the proto definition for this message. If any rules are violated, the
// result is a list of violation errors wrapped in UserInfoSecureMultiError,
// or nil if none found.
func (m *UserInfoSecure) ValidateAll() error {
	return m.validate(true)
}

func (m *UserInfoSecure) validate(all bool) error {
	if m == nil {
		return nil
	}
	...
	if all {
		...
		case interface{ ValidateAll() error }:
			if err := v.ValidateAll(); err != nil {
				errors = append(errors, UserInfoSecureValidationError{
					field:  "CreatedAt",
					reason: "embedded message failed validation",
					cause:  err,
				})
		...
		if err := v.Validate(); err != nil {
			return UserInfoSecureValidationError{
				field:  "CreatedAt",
				reason: "embedded message failed validation",
				cause:  err,
			}
	...
	if len(errors) > 0 {
		return UserInfoSecureMultiError(errors)
	}

	return nil
}

// UserInfoSecureMultiError is an error wrapping multiple validation errors
// returned by UserInfoSecure.ValidateAll() if the designated constraints
// aren't met.
type UserInfoSecureMultiError []error

// Error returns a concatenation of all the error messages it wraps.
func (m UserInfoSecureMultiError) Error() string {
	var msgs []string
	for _, err := range m {
		msgs = append(msgs, err.Error())
	}
...
// AllErrors returns a list of validation violation errors.
func (m UserInfoSecureMultiError) AllErrors() []error { return m }

// UserInfoSecureValidationError is the validation error returned by
// UserInfoSecure.Validate if the designated constraints aren't met.
type UserInfoSecureValidationError struct {
	field  string
	reason string
	cause  error
	key    bool
...
// Field function returns field value.
func (e UserInfoSecureValidationError) Field() string { return e.field }

// Reason function returns reason value.
func (e UserInfoSecureValidationError) Reason() string { return e.reason }

// Cause function returns cause value.
func (e UserInfoSecureValidationError) Cause() error { return e.cause }

// Key function returns key value.
func (e UserInfoSecureValidationError) Key() bool { return e.key }

// ErrorName returns error name.
func (e UserInfoSecureValidationError) ErrorName() string { return "UserInfoSecureValidationError" }

// Error satisfies the builtin error interface
func (e UserInfoSecureValidationError) Error() string {
	cause := ""
	if e.cause != nil {
		cause = fmt.Sprintf(" | caused by: %v", e.cause)
	}
...
var _ error = UserInfoSecureValidationError{}
