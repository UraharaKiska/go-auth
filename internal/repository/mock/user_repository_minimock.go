...
//go:generate minimock -i github.com/UraharaKiska/go-auth/internal/repository.UserRepository -o user_repository_minimock.go -n UserRepositoryMock -p mock
...
type UserRepositoryMock struct {
	...
	funcUpdate          func(ctx context.Context, info *modelRepo.UpdateUserInfo, id int64) (err error)
	funcUpdateOrigin    string
	inspectFuncUpdate   func(ctx context.Context, info *modelRepo.UpdateUserInfo, id int64)
...
func (mmUpdate *mUserRepositoryMockUpdate) Expect(ctx context.Context, info *modelRepo.UpdateUserInfo, id int64) *mUserRepositoryMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &UserRepositoryMockUpdateParams{ctx, info, id}
...
// ExpectInfoParam2 sets up expected param info for UserRepository.Update
func (mmUpdate *mUserRepositoryMockUpdate) ExpectInfoParam2(info *modelRepo.UpdateUserInfo) *mUserRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
// ExpectIdParam3 sets up expected param id for UserRepository.Update
func (mmUpdate *mUserRepositoryMockUpdate) ExpectIdParam3(id int64) *mUserRepositoryMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mUserRepositoryMockUpdate) Inspect(f func(ctx context.Context, info *modelRepo.UpdateUserInfo, id int64)) *mUserRepositoryMockUpdate {
...
func (mmUpdate *mUserRepositoryMockUpdate) Set(f func(ctx context.Context, info *modelRepo.UpdateUserInfo, id int64) (err error)) *UserRepositoryMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mUserRepositoryMockUpdate) When(ctx context.Context, info *modelRepo.UpdateUserInfo, id int64) *UserRepositoryMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("UserRepositoryMock.Update mock is already set by Set")
	}
	...
	expectation := &UserRepositoryMockUpdateExpectation{
		mock:               mmUpdate.mock,
		params:             &UserRepositoryMockUpdateParams{ctx, info, id},
...
func (mmUpdate *UserRepositoryMock) Update(ctx context.Context, info *modelRepo.UpdateUserInfo, id int64) (err error) {
	...
	if mmUpdate.inspectFuncUpdate != nil {
		mmUpdate.inspectFuncUpdate(ctx, info, id)
	}

	mm_params := UserRepositoryMockUpdateParams{ctx, info, id}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := UserRepositoryMockUpdateParams{ctx, info, id}
	...
	if mmUpdate.funcUpdate != nil {
		return mmUpdate.funcUpdate(ctx, info, id)
	}
	mmUpdate.t.Fatalf("Unexpected call to UserRepositoryMock.Update. %v %v %v", ctx, info, id)
	return
}
