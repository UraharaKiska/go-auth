...
//go:generate minimock -i github.com/UraharaKiska/go-auth/internal/service.AuthService -o auth_service_minimock.go -n AuthServiceMock -p mock
...
type AuthServiceMock struct {
	...
	funcUpdate          func(ctx context.Context, info *model.UserUpdateInfo, id int64) (err error)
	funcUpdateOrigin    string
	inspectFuncUpdate   func(ctx context.Context, info *model.UserUpdateInfo, id int64)
...
func (mmUpdate *mAuthServiceMockUpdate) Expect(ctx context.Context, info *model.UserUpdateInfo, id int64) *mAuthServiceMockUpdate {
	...
	mmUpdate.defaultExpectation.params = &AuthServiceMockUpdateParams{ctx, info, id}
...
// ExpectInfoParam2 sets up expected param info for AuthService.Update
func (mmUpdate *mAuthServiceMockUpdate) ExpectInfoParam2(info *model.UserUpdateInfo) *mAuthServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthServiceMock.Update mock is already set by Set")
	}
...
// ExpectIdParam3 sets up expected param id for AuthService.Update
func (mmUpdate *mAuthServiceMockUpdate) ExpectIdParam3(id int64) *mAuthServiceMockUpdate {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthServiceMock.Update mock is already set by Set")
	}
...
func (mmUpdate *mAuthServiceMockUpdate) Inspect(f func(ctx context.Context, info *model.UserUpdateInfo, id int64)) *mAuthServiceMockUpdate {
...
func (mmUpdate *mAuthServiceMockUpdate) Set(f func(ctx context.Context, info *model.UserUpdateInfo, id int64) (err error)) *AuthServiceMock {
	if mmUpdate.defaultExpectation != nil {
...
// Then helper
func (mmUpdate *mAuthServiceMockUpdate) When(ctx context.Context, info *model.UserUpdateInfo, id int64) *AuthServiceMockUpdateExpectation {
	if mmUpdate.mock.funcUpdate != nil {
		mmUpdate.mock.t.Fatalf("AuthServiceMock.Update mock is already set by Set")
	}
	...
	expectation := &AuthServiceMockUpdateExpectation{
		mock:               mmUpdate.mock,
		params:             &AuthServiceMockUpdateParams{ctx, info, id},
...
func (mmUpdate *AuthServiceMock) Update(ctx context.Context, info *model.UserUpdateInfo, id int64) (err error) {
	...
	mm_params := AuthServiceMockUpdateParams{ctx, info, id}
	...
	if mmUpdate.UpdateMock.defaultExpectation != nil {
		...
		mm_got := AuthServiceMockUpdateParams{ctx, info, id}
	...
	mmUpdate.t.Fatalf("Unexpected call to AuthServiceMock.Update. %v %v %v", ctx, info, id)
	return
}
